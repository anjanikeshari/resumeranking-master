...
def programmingScore(resume, jdTxt, progWords = None):
    ...
    if(progWords == None):
        programming = ["assembly", "liferay","MySQL", "bash", " c " "c++", "c#", "coffeescript", "emacs lisp",
         ...
         "TCS BaNcs", "FIS Profile", "SuccessFactors", "SF", "Success Factors"]
    else:
...
def NonTechnicalSkillScore(resume, jd_txt, progWords = None):
    ...
    skill_threshold = 5
    fout = open("results.tex", "a")
    fout.write("\\textbf{Non Programming skill:} \\\\\n")
